<template>
  <div class="chart pt-10">
    ...
    <div id="container" class="mapChart"></div>
     ...
     let option = {
        ...
        tooltip: {
            ...
            formatter: function(p) {
              let str ="<span style='color:#6ff'>"+p.name+'&nbsp&nbsp'+ p.seriesName +'</span>'+ '<br/>' + '已开发项目' + ':' + p.value
...
console.log(option,'-----');
      ...
      function showProvince(eName,param) {
        ...
        axios.get(`/map/province/${eName}.json`, data=>{
          that.$echarts.registerMap(param, data);
          console.log(data,param,'））000');
          alert("省")
          initEcharts(param);
        })
      }
      ...
      function showCitys(cName, param) {
        ...
        // 显示县级地图
        axios.get(`/map/city/${cName}.json`, data=>{
          that.$echarts.registerMap(param, data);
          alert("县")
          initEcharts(param);
        })
