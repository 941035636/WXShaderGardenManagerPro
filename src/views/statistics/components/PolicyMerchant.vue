            ...
            <el-row type="flex" class="row-bg">
                <el-col :span="24">
                    ...
                    <el-table :data="data1" style="width: 100%;margin-top:20px;" highlight-current-row show-header border fit :header-cell-style="getRowClass1">
						...
						<el-table-column label="企业名称" min-width="150" prop="companyName"></el-table-column>
						<el-table-column label="商户地址" align="center" min-width="60" prop="areaNmae">
                        </el-table-column>
						<el-table-column label="详细地址" align="center" min-width="60" prop="address">
                        </el-table-column>
...
export default {
	...
	methods: {
        ...
        async policylistDT(){ // 获取投保单列表
			...
			let res  = await this.StatisticService.postShop(this.data);
		...
		async exportList(){ // 导出
			if(this.total <= 5000){
				...
				let href = this.$apiUrl.SHOPEXCEL +
