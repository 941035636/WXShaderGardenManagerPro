<template>
    <div id="fileInfo">
        <div class="edit-top">
            <span class="content-title col-orange">上传相关结案文件</span>
            ...
            <el-dialog title="资料上传" :visible.sync="dialogVisible" width="40%" destroy-on-close>
                <el-form :model="ruleForm" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                    <el-form-item label="资料类型:">
                        <el-select v-model="ruleForm.typeId" placeholder="请选择资料类型" @change="choice" disabled>
                            <el-option v-for="item in csaeDictionaries.fileType" :key="item.value" :label="item.label" :value="item.value"></el-option>
                        </el-select>
                    </el-form-item>
                ...
                <h5 class="fc">附件列表:</h5>
                <div>
                    <span class="notes">注:附件类</span><span style="margin-left:-12px;color:#FE8181;">型(doc、docx、xls、xlsx、ppt、pptx、pdf、rar、zip)，单文件上限10MB</span>
                    <el-upload class="upload-demo" action="#" :http-request="Upload" multiple :file-list="fileList" :show-file-list="false" :before-upload="beforeAvatarUpload" accept=".doc , .docx , .ppt , .pptx , .pdf , .rar , .zip , .xlsx , .xls">
