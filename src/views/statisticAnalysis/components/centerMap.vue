      ...
      <el-row style="height: 100%">
        ...
        <el-col :span="6">
          <div class="border-four">
            <p>保单数</p>
            <p>
              {{ cityData.shouldInsureCorpJoinNum || 0 | ThousandSeparator }}
            </p>
          </div>
        </el-col>
        <el-col :span="6">
          <div class="border-four">
            <p>事故预防服务次数</p>
            <p>{{ cityData.accidentServicesNum || 0 | ThousandSeparator }}</p>
          </div>
        </el-col>
      </el-row>
    </div>
    <div class="back_title">
      <span>投保企业大数据分析显示平台</span>
      <button v-if="showBtn" @click="backMap">返回</button>
    </div>
    <div class="indus">
      <el-select
...
#centerMap {
  ...
  .top {
    ...
    .border-four {
      ...
      background-image: url('~@/assets/echartsImg/a16.png');
  ...
  .back_title {
    width: 100%;
    height: 7%;
    background-image: url('~@/assets/echartsImg/a22.png');
    background-size: 100% 100%;
    display: flex;
    box-sizing: border-box;
    justify-content: center;
