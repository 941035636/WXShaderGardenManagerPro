	...
	<div class="object-search" id="objectSearch">
		<div class="content">
			...
			<div v-show="tabState == '1'">
				<PolicyDetailPerson ref="PolicyDetailPerson" @goToDetail='goToDetail'  :data="data"></PolicyDetailPerson>
			</div>
			<!-- 设备 -->
			...
			<div v-show="tabState == '4'">
				<SequipList ref="SequipList"></SequipList>
			</div>
			<!-- 补录人员清单 -->
			<div v-show="tabState == '5'">
				<PersonList ref="PersonList"></PersonList>
			</div>
		</div>
	</div>
</template>
...
import SequipList from './batchManagementList.vue'
import PersonList from './batchManagementPerList.vue'
import moment from 'moment';
export default {
	components:{
		PolicyDetailPerson,PolicyDetailSequip,PolicyProperty,SequipList,PersonList,PolicyCableway,PolicyMerchant
	},
	data() {
		return {
			proSortName:'',
