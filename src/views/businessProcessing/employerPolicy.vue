	...
	<div class="employerPolicy" id="employerPolicy">
		...
		<div class="content">
			<div class="content1">
				...
				<span class="content1-exports"  @click="exports" v-if="datas.find(item => item.key == '10018')"><img src="../../../static/img/dus.png" alt="">批量导出</span>
			</div>
					...
					<div class="table-data">
						<div class="title1 data-item">
							<div class="centered-block">
								...
								<p class="color-gray-3 f14 lh30" v-if="datas.find(item => item.key == '10037')">
						...
						<div class="title3 data-item">
							<div class="centered-block text-center">
								...
								<p class="font-colo f14 lh30" @click="premium(row)" v-if="row.state == '01' && datas.find(item => item.key == '10013') && row.pushStatus != '01' && row.pushStatus != '02'">修改保费</p>
						...
						<div class="title6 data-item">
							<div class="state-item">
								<div class="centered-block text-center">
									<p class="font-colo f14 lh30" @click="enquirydetails(row)" v-if="datas.find(item => item.key == '10010')">查看详情</p>
									<p class="font-colo f14 lh30" @click="relation(row)" v-if="datas.find(item => item.key == '10011')">人员清单</p>
									<p class="font-colo f14 lh30" @click="paymentnotice(row)" v-if="row.state == '01' && datas.find(item => item.key == '10012')">支付通知</p>
									<p class="font-colo f14 lh30" @click="identification(row)" v-if="row.state == '01' && datas.find(item => item.key=='10014') && row.productCode != '19PR627806'">到账确认</p>
									<p class="font-colo f14 lh30" @click="policyupload(row)" v-if="row.state == '02' && datas.find(item => item.key=='10015')">保单上传</p>
									<p class="font-colo f14 lh30" @click="endorsements(row)" v-if="datas.find(item => item.key == '10016') && row.state == '03' || datas.find(item => item.key == '10016') && row.state == '04'">批单补录</p>
									<p class="font-colo f14 lh30" @click="missMessage(row)" v-if="row.state == '08' && row.productCodes == '1' && datas.find(item => item.key == '10017')">报错报文</p>
...
export default {
	...
	created(){
		...
		this.getArea();
		this.loadBranch();
		if(window.localStorage.getItem('index') == '2' && window.localStorage.getItem('data')){
			this.gettingCache();
		}else{
