  ...
  <div>
    ...
    >
      ...
      >
        ...
        <!-- {{ ruleForm.industryId2.indexOf('15') }}
        {{ ruleForm.industryOne }} -->
        <!-- <el-row v-if="ruleForm.industryOne == '15'">
          <Title borderStyle="6px solid #096dd9" title="项目信息"></Title>
          <el-form-item
            :rules="
          ...
          <el-table
            ...
            "
            border
            style="width: 80%; margin: 0px 100px"
          >
            ...
            <el-table-column label="操作" width="100">
              <template slot-scope="scope">
                <p class="m0">
                  ...
                  <el-button type="text" @click="dele(scope.$index)">
                    删除
                  </el-button>
                </p>
              </template>
        ...
        <el-form-item prop="safetyProdLicenseEnd">
          <el-date-picker
  ...
  methods: {
    ...
    detail(index, row) {
      ...
      if (this.isInsured) {
        ...
        console.log(
          this.$refs.detail.ruleForm.address,
          'this.$refs.detail.ruleForm.address'
        )
        this.$refs.detail.ruleForm.detailAddress = row.projectDetailAddress
    ...
    addList() {
      ...
      if (this.ruleForm.detailAddres.length >= 100) {
      ...
      let obj = {
        ...
        projectProvinceName: this.areaMap[this.ruleForm.address[0]] || '',

        countyName: this.areaMap[this.ruleForm.address[2]] || '',
        projectCountyName: this.areaMap[this.ruleForm.address[2]] || '',

        cityName: this.areaMap[this.ruleForm.address[1]] || '',
        projectCityName: this.areaMap[this.ruleForm.address[1]] || '',

        provinceCode: this.ruleForm.address[0] || '',
        projectProvinceCode: this.ruleForm.address[0] || '',

        countyCode: this.ruleForm.address[2] || '',
        projectCountyCode: this.ruleForm.address[2] || '',

        cityCode: this.ruleForm.address[1] || '',
        projectCityCode: this.ruleForm.address[1] || '',

        projectName: this.ruleForm.projectName, //项目名称
        // address: this.ruleForm.address,//地址
        detailAddress: this.ruleForm.detailAddres, //详细地址
        projectDetailAddress: this.ruleForm.detailAddres, //详细地址
        dataStatus: true, //状态
    ...
    async getOrgDetail() {
      ...
      if (code === '0000') {
        this.projectList = data.constructionProjectRespList
          ...
          : []
        this.ruleForm = data
        this.ruleForm.annualTurnover = data.annualTurnover
          ? data.annualTurnover.toFixed(2)
          : ''
        this.ruleForm.securityChargerEmail = data.securityChargerEmail
