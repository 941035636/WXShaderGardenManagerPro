        ...
        <div class="ts-insure-scheme">
            <el-form :label-position="labelPosition" label-width="100px" ref="ruleForm" :inline="true" :model="ruleForm" class="demo-form-inline" :rules="formRules">
                ...
                <el-form-item label="证件类型" prop="codeType">
                    <!-- <el-input v-model="ruleForm.codeType"></el-input> -->
                    <el-select v-model="ruleForm.codeType" clearable placeholder="请选择" style="width:352px">
                        <el-option
    ...
    methods: {
        ...
        getInsureds() {
            ...
            this.$refs['ruleForm'].validate((valid) => {
                if (valid) {
                    if(this.ruleForm.codeType == '工商营业执照') {
                        this.ruleForm.threeInOneCode = this.ruleForm.codeNum;
                    } else if(this.ruleForm.codeType == '组织机构代码证') {
                        this.ruleForm.organizationCode = this.ruleForm.codeNum;
                    }
