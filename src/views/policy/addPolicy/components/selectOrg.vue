  ...
  <div id="selectOrg">
    ...
    >
      ...
      >
          ...
          >
            <template slot-scope="{ item }">
              <div class="item-sel">
                ...
                <p>
                  行业领域：{{
                    item.administrations ? item.administrations[0].itemText : ''
                  }}
                  <span v-if="item.administrations && item.administrations[1]">
        ...
        <div v-if="ruleForm.custFullName">
    ...
    <detail :projectFlay="projectFlay" ref="detail" />
  </div>
</template>
