<template>
  <div id="production">
    ...
    >
      ...
      ></el-table-column>
      <el-table-column
        prop="accidentPreRecordEntity.problemDesc"
        label="问题描述"
      >
        <template slot-scope="scope">
          <span>
            {{
              scope.row.accidentPreRecordEntity.problemDesc
                ? scope.row.accidentPreRecordEntity.problemDesc
                : ''
            }}
          </span>
      ...
      <el-table-column
        prop="accidentPreRecordEntity.deductPoints"
        label="问题扣分"
        width="245"
      >
        <template slot-scope="scope">
          <span>
            {{
              scope.row.accidentPreRecordEntity.deductPoints
                ? scope.row.accidentPreRecordEntity.deductPoints
                : '暂无'
            }}
          </span>
