<template>
	<div class="casePending" id="casePending">
        ...
        <el-col :span="8">
					<span class="text-left">正常/中止:</span>
					<el-select v-model="formInline.substate" filterable placeholder="请选择" size="medium" clearable>
						<el-option  label="正常" value="0"></el-option>
						<el-option  label="中止" value="1"></el-option>
					</el-select>
				</el-col>
			</el-row>
			<el-row class="mb20">
    ...
    <div class="content-table">
      ...
      <CaseListTable fatherComponents="casePending" :tableData="dataCaseList" @successCallback="caseList"> </CaseListTable>
	...
	data() {
		return {
			formInline:{
				...
				ps:10,
				substate: null,
        reportStatusList:'00,02,03,04',
				timeTypes: '2', // 时间类型标识
        servicerCode:window.sessionStorage.getItem('userCode')
			},
			reportTime: [],//报案时间
			riskTime: [],//出险时间
			optionsArea:[],
