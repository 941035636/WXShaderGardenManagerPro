<template>
    <div id="claimInformationPF">
        <div class="edit-top">
            <span class="col-orange"><span class="col-orange-bor"></span>赔付信息</span>
                ...
                <span style="font-size:15px;color: #e6a23c; padding: 0px 35px 5px; display: inline-block; font-weight: 700;">理赔明细</span>
                    <div class="pb20">
                        <el-row class="con-row" >
                            <el-col :span="6">
                                <span>理赔金额：</span>
                                <span class="col-red">{{'￥'+Number(payInfo.LPmoney).toFixed(2)}}</span><span>元(CNY人民币)</span>
                            </el-col>
                            <el-col :span="6">
                                <span>保险公司是否已核赔：</span>
...
export default {
    ...
    methods: {
        ...
        toEditPass(){//打开弹框
            ...
            // 先要上传索赔信息，才能上传理赔信息
            if(this.payInfo.id =='') {
                this.$message.error('索赔信息，不能为空')
            } else {
                this.showPayInfo = true;
                this.$refs.checkData.checkData(1);
            }
        },
