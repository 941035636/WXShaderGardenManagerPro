	...
	<div id="CablewayCaseList">
		...
		<div class="content-table" v-else>
			...
			<div class="content-up">
				...
				<el-button v-if="dataJurisdiction.find(item => item.key == '40006')"  class="content-up-btn" type="primary" @click="exports" round>导出</el-button>
			</div>
			<div class="content">
				...
				<div class="content-item" v-for="(item,index) in data1" :key="index">
					<el-row type="flex" class="row-bg">
						<!-- <el-col :span="10"><div style="padding:15px;box-sizing: border-box;">
							...
							<p><span>估损：</span><span class="mr40" style="color:#FF6F70;">{{item.appraisalAmount}}</span> <span>赔付金额：</span><span style="color:#FF6F70;">{{item.settlementclaimAmount}}</span></p>
						...
						<el-col :span="8"><div style="padding:15px;box-sizing: border-box;">
							...
							<p><span>事故原因：</span><span style="color:#FF6F70">{{item.accidentReasonName}}</span></p>
