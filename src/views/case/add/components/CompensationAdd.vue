    ...
    <div class="content_item ml30 lh30">
      ...
      >
        ...
        <div class="conBox mb20">
          ...
          <p v-if="injuryPerson" class="mention">
            <i class="el-icon-warning"></i>
            人身伤亡赔付金额非0时，请添加从业人员信息
          </p>
          <el-row v-if="injuryPerson">
            <el-col :span="24">
              <div class="add-info" @click="addMember">
                ...
                >
                  ...
                  >
                    <template slot-scope="scope">
                      ...
                      <span v-if="scope.row.certificateType == '02'">
                        士官证
                      </span>
        ...
        <div class="conBox mb20">
          ...
          <el-row v-if="partyLoss">
            <el-col :span="24">
              <div class="add-info" @click="addPerson">
                <i class="el-icon-plus"></i>
                添加第三者信息
              </div>
            </el-col>
          ...
          <el-row v-if="partyLoss" class="mb20">
            <el-col class="tb" :span="24">
        ...
        <el-row>
          ...
          <el-col :span="9">
            <el-form-item label="赔付总金额：" prop="otherAmount">
              <el-input-number
                v-if="payTotal"
                :value="payTotal"
                class="w220"
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="是否结案：">
              <!-- <span class="mr10">有无财产损失</span> -->
              <span>
                <el-switch v-model="showBtn" @change="changeBtn1"></el-switch>
              </span>
            </el-form-item>
            <span class="color-red">
              <i style="vertical-align: middle" class="f18 el-icon-warning"></i>
              案件信息填写不完整时关闭开关【不结案】后续进行补充；案件信息填写完整后打开开关【一键结案】
            </span>
          </el-col>
        </el-row>
      </el-form>
      <div v-if="!showCompensate" class="emptyBox">
        <span @click="addCompensate">添加</span>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  data() {
    return {
      ...
      photoList: [], //暂存文件
      injuryPerson: true, //有无人员伤亡
      partyLoss: true, //有无财产损失
  ...
  methods: {
    changeBtn1(e) {
      this.$emit('changeBtn', e)
    },
    cancleBtn() {
      this.$emit('changeFinal', false)
      this.showCompensate = false
    },
    addCompensate() {
      this.$emit('changeFinal', true)
    ...
    changeLoss(e) {
      ...
      if (e) {
        ...
        this.$confirm('请确认是否存在第三者财产损失情况?', '提示', {
          confirmButtonText: '确定',
          cancelButtonText: '取消',
          type: 'warning',
        })
...
html body #CompensationAdd .el-table .headName .cell {
  font-weight: bold;
  color: #fff;
}
</style>
