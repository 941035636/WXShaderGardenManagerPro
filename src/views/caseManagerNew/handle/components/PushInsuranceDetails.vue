<template>
  <div id="PushInsuranceDetails" v-if="pushInsuranceFlag">
      ...
      <div class="title">
          ...
          <div class="title-r">
                <img src="../../../../assets/images/md-cloud-done.png" alt="" srcset="" style="margin-right:20px">
               <span style="color:#FA8C16;margin-right:20px">检测到保司结案数据，点击按钮查看详情</span> 
      ...
      <div>
          <el-table
            ...
            >
            <template slot-scope="sopced">
                    <span>{{sopced.row.casePayTime}}</span>
                     <span v-if="sopced.row.casePayTime" @click="shareCopy(sopced.row.casePayTime)" style="color:#FA8C16;cursor: pointer;text-decoration:underline">复制</span>
                </template>
            </el-table-column>
            <el-table-column
                prop="settleTypeName"
            ...
            <el-table-column
                ...
                <template slot-scope="sopced">
                    ...
                    <span v-if="sopced.row.estimatedLossAmount" @click="shareCopy(sopced.row.estimatedLossAmount)" style="color:#FA8C16;cursor: pointer;text-decoration:underline">复制</span>
                </template>
            </el-table-column>
            <el-table-column
                prop="totalMoney"
                ...
                <template slot-scope="sopced">
                    ...
                    <span v-if="sopced.row.totalMoney" @click="shareCopy(sopced.row.totalMoney)" style="color:#FA8C16;cursor: pointer;text-decoration:underline">复制</span>
                </template>
            </el-table-column>
...
export default {
    ...
    computed: {
        ...mapGetters({pushInsuranceData:'pushInsuranceDataNew'}),
    ...
    mounted() {
         console.log(this.pushInsuranceData);
    },
    methods: {
