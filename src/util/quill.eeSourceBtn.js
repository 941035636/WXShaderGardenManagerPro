class eeSourceBtn {
    ...
    addDom(quill) {
        if (!quill.container.querySelector(".ql-ee-source")) {
            ...
            txtArea.style.cssText = "width: 100%;margin: 0px;box-sizing: none;font-size: 13px;outline: none;padding: 12px 15px;line-height: 1.42;font-family: Consolas, Menlo, Monaco, &quot;Courier New&quot;, monospace;position: absolute;top: 0;bottom: 0;border: none;"
    ...
    showSourceEditor(quill) {
        ...
        if (sourceContainer.style.display === 'none') {
            ...
            // 使用dangerouslyPasteHTML方法将HTML内容插入到Quill编辑器中 会引起页面刷新
