...
<script>
  ...
  export default {
    ...
    created() {
      ...
      const theme = localStorage.getItem('yingji-admin-theme')
      if (null !== theme) {
    ...
    methods: {
      ...
      handleSetTheme() {
        ...
        document.getElementsByTagName(
          'body'
        )[0].className = `yingji-admin-theme-${name}`
      ...
      handleSetDfaultTheme() {
        ...
        document
          ...
          .classList.remove(`yingji-admin-theme-${name}`)
        localStorage.removeItem('yingji-admin-theme')
